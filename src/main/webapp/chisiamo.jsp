    ...
    <div class="container">
        ...
        <div>
            <div id="our_goals">
                ...
                <img src="img/chisiamo_3.jpg" width="200px" alt="chi siamo">
            </div>
            ...
            <div id="our_story">
                ...
                <img src="img/chisiamo_4.jpg" width="200px" alt="chi siamo">
            </div>

            <div id="today">
                <h3>I nostri risultati</h3>
                <p>Ad oggi siamo più di <strong>800 volontari!</strong></p>
                <img src="img/chisiamo_1.jpg" width="200px" alt="chi siamo">
                <p>Abbiamo già curato più di <strong>10 000 persone</strong> e ci hanno riconosciuto come
