...
<body>
    ...
    <div class="container">
        ...
        <div>
            ...
            <h3>Fornitura di cure mediche</h3>
            <p>Tum4World organizza missioni mediche in cui i volontari, tra cui medici, infermieri e
        ...
        <div>
            ...
            <h3>Programmi di educazione sanitaria</h3>
            <p>L'associazione realizza programmi di sensibilizzazione e formazione sulla salute e l'igiene
        ...
        <div>
            ...
            <h3>Progetti di sviluppo comunitario</h3>
            <p> Tum4World collabora con le comunità locali per implementare progetti di sviluppo sostenibile.
